...
function EnrollPro() {
  return (
    <div className="army-enrollProc-container">
      <NavBar/>
      <p className="army-heading-title">Enrollment Procedure</p>

      <div className="army-enrollPro">
        <p>
        ...
        <div className="army-prolist">
          ...
          <ol className="army-list2" style={{ listStyleType: "lower-alpha" }}>
            <li>
              {" "}
